...
| MapLibre React Native RasterSource docs, checked 2026-06-02: `https://maplibre.org/maplibre-react-native/docs/components/sources/raster-source/` | Raster sources use TileJSON URLs or tile URL templates and attribution metadata. | This does not prove raw MBTiles/PMTiles native archive rendering. |
| MapLibre React Native VectorSource docs, checked 2026-06-02: `https://maplibre.org/maplibre-react-native/docs/components/sources/vector-source/` | Vector sources use TileJSON URLs or vector tile URL templates, and query loaded vector tile features by source layer. | This does not provide a local raw PMTiles/MBTiles native protocol by itself. |
