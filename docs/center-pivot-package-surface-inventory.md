...
| `apps/mobile/` | Expo React Native app, panels, settings UI, design awareness review, local cost-assumption review, generated review-zone save action, obstacle interaction review, drawing tools, and export/import controls. | Wire package APIs after tests pass. Use Expo packages for native dependencies when needed. Keep Awareness / Design Review advisory and local; applying pivot candidates and saving generated review zones remain explicit operator actions, operator cost inputs are not vendor quotes, and obstacle interaction categories do not prove crossing/passability. |
...
- Advisory machine zones, planning boundaries, linear move paths, measurement lines, pump/well locations, pipe/wire paths, power poles/lines, imported pivot evidence, generated within-field multi-pivot screening, full-scope compiled-boundary geometry/coverage metrics, projected collision/review zones, local cost assumptions, obstacle interaction categories, bender/second-pivot opportunity envelopes, and machine-strategy comparisons are project review data. They do not implement runtime/certified multi-pivot collision prevention, bender/corner-arm proprietary kinematics, certified object crossing/passability, certified linear/lateral design, automatic/vendor cost quotes, client-ready final reports, or Google Earth/native runtime proof.
