...
- Advisory machine zones, planning boundaries, linear move paths, measurement lines, pump/well locations, pipe/wire paths, power poles/lines, imported pivot evidence, projected collision/review zones, local cost assumptions, obstacle interaction categories, bender/second-pivot opportunity envelopes, and machine-strategy comparisons are project review data. They do not implement runtime/certified multi-pivot collision prevention, bender/corner-arm proprietary kinematics, certified object crossing/passability, certified linear/lateral design, automatic/vendor cost quotes, or Google Earth/native runtime proof.
