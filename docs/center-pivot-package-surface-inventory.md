...
- Advisory machine zones, planning boundaries, linear move paths, measurement lines, wells, wire paths, imported pivot evidence, and machine-strategy comparisons are project review data. They do not implement certified multi-pivot collision prevention, bender/corner-arm proprietary kinematics, certified linear/lateral design, automatic cost quotes, or Google Earth/native runtime proof.
