...
- Multi-machine advisory review: `analyzeAdvisoryMultiMachineLayout` compiles planning boundaries and machine zones into transient machine scenarios, modeled union acres, and conservative machine-envelope separation warnings while preserving `canonicalGeometryMutation: false`.
