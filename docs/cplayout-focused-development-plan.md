...
- Real-pivot fixture automation: `npm run real-pivot-fixture:generate` creates `fixtures/real-pivot/manifest.json` from the public Adams County project reference plus local Google Earth proof artifacts and hashes for companion analysis without canonical geometry mutation.
