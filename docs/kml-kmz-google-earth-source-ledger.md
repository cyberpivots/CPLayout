...
- Android native file picker/share behavior has historical schema-v8 and schema-v10 artifact-specific evidence for the canonical project ZIP package; current schema-v11 Android behavior, iOS behavior, and any KML/KMZ-specific native picker/share regression still need their own checklist evidence.
