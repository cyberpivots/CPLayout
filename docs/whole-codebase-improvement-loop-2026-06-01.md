...
Iterations 001-010 are complete. Later rows remain planned until their evidence exists. This loop intentionally started from the current dirty tree rather than assuming a clean baseline.
