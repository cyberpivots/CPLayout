...
export type MapClickIntent =
  | { type: "none"; reason: "pan" | "edit_vertices" | "layout_mode_no_mutation" }
...
export interface MapClickIntentParams {
...
export function mapClickToProjectedIntent(params: MapClickIntentParams): MapClickIntent {
  if (params.workflowMode !== "design") return { type: "none", reason: "layout_mode_no_mutation" };
  ...
  if (params.mode === "capture_point") {
    return {
      ...
      point: {
        ...
        source: "manual",
        confidence,
        notes: params.imageryEnabled ? "Captured from imagery; verify with field survey." : undefined,
      },
    };
  }
