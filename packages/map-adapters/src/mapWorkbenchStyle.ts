...
export function buildWorkbenchStyle(
  ...
  layers.push(
    ...
    fillLayer("advisory-machine-lrdu-path-fill", "advisory_machine_lrdu_path", "#111c17", 0.08),
    fillLayer("advisory-machine-tower-path-fill", "advisory_machine_tower_path", "#54645a", 0.1),
    fillLayer("advisory-machine-corner-wheel-path-fill", "advisory_machine_corner_arm_wheel_path", "#8b6f2a", 0.12),
    fillLayer("advisory-machine-corner-overhang-path-fill", "advisory_machine_corner_arm_overhang_end_path", "#1f5f66", 0.1),
